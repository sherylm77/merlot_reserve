...
# else:
#     args.num_folds = 8
# args.data_dir = '/work/sheryl/siq2/'
...
def parse_item(item):
    ...
    for trow in times_used0:
        ...
        fn = os.path.join(frames_path, item['vid_name'] + "_" + f'{t_mid_3ps_idx:03d}.jpg')
    ...
    sub_fn = os.path.join(os.environ["TRANSCRIPT_PATH"], show_subname + '.vtt')
